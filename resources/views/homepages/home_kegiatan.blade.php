        ...
        <div class="col-md-6 col-lg-4 mb-3 mb-md-4">
            <div class="card h-100 hover-box-shadow">
              <div class="d-block bg-gradient rounded-top position-relative">
                <img class="card-img-top hover-fade-out" src="{{Storage::url($kegiatan->foto_kegiatan)}}" alt="Image accompanying Treva testimonial">
              </div>
              <div class="card-body">
              <h3>{{$kegiatan->nama_kegiatan}}</h3>
                <p>
                  {{Str::limit($kegiatan->keterangan, $limit = 100,$end = "...")}}
                </p>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <h3 style="text-align:center;">{{$kegiatan->nama_kegiatan}}</h3>
            <img class="card-img-top hover-fade-out" src="{{Storage::url($kegiatan->foto_kegiatan)}}" alt="Image accompanying Treva testimonial">
            <br><br>
